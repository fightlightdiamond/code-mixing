      ...
      <div className="w-full max-w-md">
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Tham gia cộng đồng học tiếng Anh IT
            </CardDescription>
          </CardHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <label className="flex items-center space-x-2 cursor-pointer">
                    ...
                    />
                    <span className={`text-sm ${selectedRole === 'student' ? 'font-medium text-green-600' : 'text-gray-600'}`}>
                      🎓 Học viên
                    </span>
                  </label>
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      className="text-green-600"
                    />
                    <span className={`text-sm ${selectedRole === 'coach' ? 'font-medium text-green-600' : 'text-gray-600'}`}>
                      👨‍🏫 Giảng viên
                    </span>
                  </label>
                </div>
